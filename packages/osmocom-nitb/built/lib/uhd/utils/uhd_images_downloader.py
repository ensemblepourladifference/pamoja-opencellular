...
_DEFAULT_INSTALL_PATH     = os.path.join("/usr/local/osmo_built", *_BASE_DIR_STRUCTURE_PARTS)
_DEFAULT_BASE_URL         = "http://files.ettus.com/binaries/images/"
_AUTOGEN_IMAGES_FILENAME  = "uhd-images_003.010.001.001-7-g63fcfb95.zip"
_AUTOGEN_IMAGES_CHECKSUM  = "53a1ea139d8344fec9914f05db79bdd0"
